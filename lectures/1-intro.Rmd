...
- Sequence
  - **8066**: Tools of statistics (distilling lots of data to interpretable numbers, sampling, hypothesis testing)
  - **8067**: Building models (how do translate our theory into testable relationships using the tools of 8066)
]
---
...
[Class Website](https://shellyc26.github.io/psy8066/index.html) -- syllabus, lecture slides, homeworks etc. 

[Slack Workspace](https://quantitativem-wva4818.slack.com) -- here for answering questions, posting stats/`R` memes, building community

[Canvas](https://wustl.instructure.com/courses/179351) -- where you will turn in your homeworks and view your grades
