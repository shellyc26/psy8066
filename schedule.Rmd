...
|:--:|:--:|:--:|:--:|:--:|
| 1 | 8/25 | Syllabus & Introductions |  |  |
| \- | 8/27 | Models |  |  |
| 2 | 9/1 | Measurements; RMarkdown/ RProjects | LSR Ch 1 & 3 |  |
| \- | 9/3 | Describing data | LSR Ch 5 & 6 |  |
| 3 | 9/8 | Describing data | LSR Ch 5 & 6, [Ozer & Funder (2019)](readings/Ozer_Funder_2019.pdf) |  |
| \- | 9/10 | Fisher tradition & probability | LSR Ch 9 | HW 1 due |
| 4 | 9/15 | Normal & binomial distributions | LSR Ch 9 |  |
| \- | 9/17 | Sampling distributions and $t$ distributions | LSR Ch 10 |  |
| 5 | 9/22 | Lab Assignment 1 |  |  |
| \- | 9/24 | **Exam 1** |  | HW 2 due |
| 6 | 9/29 | Hypothesis testing 1 | LSR Ch 11 |  |
| \- | 10/1 | Hypothesis testing 2 | LSR Ch 11 |  |
| 7 | 10/6 | *No class – Fall Break!* |  |  |
| \- | 10/8 | Critique of NHST | LSR Ch 11, [Simmons et al. (2011)](readings/Simmons_etal_2011.pdf), [Cumming (2014)](readings/Cumming_2014.pdf) |  |
| 8 | 10/13 | Open science practices | [Five Thirty Eight](https://fivethirtyeight.com/features/science-isnt-broken/) |  |
| \- | 10/15 | Chi-Square test | LSR Ch 12 |  |
| 9 | 10/20 | One-sample tests | LSR Ch 13 |  |
| \- | 10/22 | Comparing two means | LSR Ch 13 |  |
| 10 | 10/27 | Comparing dependent means | LSR Ch 13 |  |
| \- | 10/29 | Lab Assignment 2 |  | HW 3 due |
| 11 | 11/3 | **Exam 2** |  |  |
| \- | 11/5 | Introduction to model comparisons & $F$-distribution | LSR Ch 14 |  |
| 12 | 11/10 | One-way ANOVA | LSR Ch 14 |  |
| \- | 11/12 | Multiple comparisons & contrasts | LSR Ch 16 |  |
| 13 | 11/17 | Two between-subjects factors | LSR Ch 16 | HW 4 due |
| \- | 11/19 | Interactions & ANCOVA | LSR Ch 16 |  |
| 14 | 11/24 | Within-subjects designs | LSR Ch 16 |  |
| \- | 11/26 | *No Class – Happy Thanksgiving!* |  |  |
| 15 | 12/1 | Lab Assignment 3 |  | HW 5 due |
| \- | 12/3 | **Exam 3** |  |  |
...
- 5 Homework: 3% each, 15% total
- Exams: 25% for the first exam, 30% for exams 2 and 3, 85% total

NOTE: On September 9th, Shelly changed the graded material percentages. Grades will be calculated BOTH WAYS and the highest overall grade will be kept.

- 5 Homework: 3% each, 15% total
- 3 Lab Assignments (in-class): 5% each, 15% total
- Exams: 20% for the first exam, 25% for exams 2 and 3, 70% total

### Homework assignments

Homework assignments are intended to gauge your ability to apply the topics covered in class to the practice of data analysis. Homework assignments are to be done using R and RMarkdown/Quarto; completed assignments should be submitted to Canvas. Please submit BOTH your .Rmd and .html file. Please do not use PDF or Word documents. There will be 5 assignments in total, each worth 3% of your grade. Please note that assignments might change throughout the semester. However, in total, homeworks will ultimately add up to 15% of your grade.

HWs are due at their due date by 9:30am. Grading will go by the following rubric:

- 3/3: Completed all parts of the assignment, and results/interpretations were mostly correct (with maybe a few minor errors along the way)
- 2/3: Completed all parts of the assignment, and \~25% of the results/interpretations are incorrect
- 1/3: Completed all parts of the assignment, however \~50% of the results/interpretations are incorrect
- 0/3: Parts of the assignment are missing, and there are substantial issues with the results/interpretation OR nearly all of the assignment is missing, but something was turned in OR no assignment submitted
...
3.  You may NOT use Artificial Intelligence tools like OpenAI, Anthropic, etc. to complete the code in the assignment. The goal is for you to build skillsets and socialize with your peers.

### Exams

There will be 3 exams. They will test both your theoretical understanding of concepts, as well as your applied understanding of the material. You will not be expected to open `R` and code during these exams, however you will be expected to understand `R` code that has been provided. As exams get closer, I will go over the procedures and policies with you before the exam. If you have a disability that will require additional time, please contact me and Disability Resources as soon as possible (contact information below). The first exam is worth 25% of your grade. Exams 2 and 3 are each worth 30% of your grade.

There will be 2 portions to each exam. The first part is a written exam to be taken during class time. The second portion will be an **oral** exam! You will schedule a time with me (you will sign up on Calendly for available times – I will send this to you). Each oral exam to take longer than 10-15 minutes and will be worth between 10-15% of the exam grade.
...
You are new grdaduate students which is a strange place to be. Plus, learning stats, learning to code, and grad school in general can be really scary -- impostor syndrome is real! The best thing we can do to combat these feelings is to stay connected to one another. Here's how we'll accomplish this in our class:
...
- **If you are not feeling well, don't come to class!!** You have access to the slides and you can ask a friend for notes. Lectures will NOT be recorded.
...
Artificial Intelligence tools will not be permitted for any graded work component of this course. It is not to be used on written exams, it cannot be used on oral exams, and it cannot be used in your homework.

You are allowed to use it as a pedagogical tool to help with studying. But no graded work should be produced with artificial intelligence.
